...
int main(int argc, char** argv)
{
    ...
    std::string mesh_stl, boundary_stl, tool_path_stl, deformed_stl;

    app.add_option("--mesh", mesh_stl)->required();
    app.add_option("--boundary", boundary_stl)->required();
    app.add_option("--toolpath", tool_path_stl)->required();
    app.add_option("--deformed", deformed_stl)->required();
    ...
    {
        handler.set_stress_in_cut(tool_path_stl, deformed_stl);
